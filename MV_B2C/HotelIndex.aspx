<%@ Page Language="C#" AutoEventWireup="true" Inherits="HotelIndex" EnableEventValidation="false"
    Codebehind="HotelIndex.aspx.cs" %>

<%@ Register Src="~/UserControls/Header.ascx" TagName="Header" TagPrefix="uc3" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title meta:resourcekey="Title">Discount Hotel Resverations, Rooms & Deals : Majestic Vacations</title>
    <meta name="ROBOTS" content="NOODP"/>
    <meta name="verify-v1" content="aeVxP6zTHeQzT620ipj5+ikXd/VXcdlKoYUJ/C6vVdY=" />
</head>
<body onload="FillDiv('3');">
    <form id="form1" runat="server">
        <uc3:Header ID="Header1" runat="server" /><input id="mouseindex" type="hidden" value="F" name="DefaultTab" runat="server" />
        <input id="CurrentTab" type="hidden" value="F" name="DefaultTab" runat="server" />
        <input id="cityandairport" type="hidden" value="H" runat="server" /><input id="FlightType"
            ...
            <tr>
                ...
                <td width="615" align="right" valign="top">
                        ...
                        <tr>
                            <td>
                                <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0"
                                    ...
                                    <param name="movie" value="<%=SaleWebSuffix + ImagesPath + "ad_htl.swf"%>" />
                                    <param name="quality" value="high" />
                                    <param name="wmode" value="transparent" />
                                    <param name="bgcolor" value="#ffffff" />
                                    <embed src="<%=SaleWebSuffix + ImagesPath + "ad_htl.swf"%>" quality="high" bgcolor="#ffffff"
                    ...
                    <div style="width: 605px; height: 360px;">
                        <iframe src="<%=SaleWebSuffix + HtmlPath + "hotel_indexpage.htm"%>" width="605" height="360"
