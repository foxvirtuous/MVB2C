<%@ Page Language="C#" AutoEventWireup="true" Inherits="Index2"
    EnableEventValidation="false" Codebehind="IndexArea.aspx.cs" %>
...
<head id="Head1" runat="server">
    <title>Majestic Vacations - The best value to Asia from USA</title>
    ...
    marginwidth="0" noresize frameborder="0" scrolling="NO" src="CommJs/Mvcalx.htm"></iframe>
        <table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="2">
                    <a href="#">
                        <img src='<%="images/v2/" + TopImageName %>' border="0"></a></td>
            </tr>
            <tr>
                <td width="305" align="left" valign="top">
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr align="center">
                                                        ...
                                                        <td id="tdH" class="D_search_off">
                                                            <a id="aH" href="javascript:ChangeTab('H')" class="search_off">Hotels</a></td>
                                                        <td width="5">
                                                            <img id="imgHr" src="images/index/en_off_r.gif" /></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div id="divSearchNonTab" runat="server">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr align="center">
                                                        <td width="5">
                                                            <img id="img1" src="images/index/en_off_l.gif" /></td>
                                                        <td class="D_search_off">
                                                            &nbsp;</td>
                                                        <td width="5">
                                                            <img id="img2" src="images/index/en_off_r.gif" /></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </td>
                    ...
                    <iframe src="Html/phone.htm" width="305" height="110" name="phone" id="phone" scrolling="no" frameborder="0"></iframe>
                </td>
                <td width="615" align="right" valign="top">
                    <%-- <table width="615" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td>
                                <a href="#">
                                    <img src="images/v2/area_cn02.jpg" border="0"></a></td>
                        </tr>
                    </table>--%>
                    <table width="615" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td height="114" valign="bottom" background='<%="images/v2/" + MainImageName %>'
                                class="D_head1" align="left">
                                &nbsp;&nbsp;&nbsp;&nbsp;<%=CountryName %></td>
                        </tr>
                        <tr>
                            <td height="10">
                    ...
                    <iframe id="content" name="content" src='<%="Html/" + PageName %>' width="605" scrolling="no"
                        frameborder="0"></iframe>
                </td>
            </tr>
        </table>
