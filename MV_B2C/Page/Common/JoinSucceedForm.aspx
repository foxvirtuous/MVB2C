<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="JoinSucceedForm" Codebehind="JoinSucceedForm.aspx.cs" %>
            ...
            <table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td height="45" align="left" valign="bottom" class="D_title">
                        &nbsp;&nbsp;<asp:Label ID="Label1" runat="server" meta:resourcekey="lblCreateMember" >Create Your Member Account</asp:Label></td>
                </tr>
            </table>
            <table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                                                ...
                                                <table border="0" align="center" cellpadding="3" cellspacing="1" class="T_table">
                                                    <tr>
                                                        <td height="80" colspan="2">
                                                            <asp:Label ID="Label2" runat="server" meta:resourcekey="lblSuccessfully" >You have created your member account successfully</asp:Label>.<asp:HyperLink ID="hlReturn" runat="server"
                                                                CssClass="d06" meta:resourcekey="lblReturnTo">Return to Majestic Vacations.</asp:HyperLink>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
