<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="MemberChangePwdForm" Codebehind="MemberChangePwdForm.aspx.cs" %>
        ...
        <table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="45" align="left" valign="bottom" class="D_title">
                    &nbsp;&nbsp;<asp:Label ID="lblInfo" runat="server" meta:resourcekey="lblInfo">Membership: Change Password</asp:Label></td>
            </tr>
        </table>
        <table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                        ...
                        <tr>
                            ...
                            <td width="80%" align="left" valign="top">
                                <table cellspacing="1" cellpadding="3" width="100%" border="0" class="T_table">
                                    &nbsp;<tr>
                                        <td>
                                            <asp:Label ID="Label1" runat="server" meta:resourcekey="lblMust">The password must be between 6 and 30 characters long</asp:Label>.<br />
                                            <br />
                                            ...
                                            <table width="100%" border="0" cellpadding="3" cellspacing="1">
                                                <tr>
                                                    <td width="23%">
                                                        <b><asp:Label ID="Label2" runat="server" meta:resourcekey="lblUserName">User Name</asp:Label>:</b></td>
                                                    <td>
                                                        <b>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label3" runat="server" meta:resourcekey="lblOldPassword">Old Password</asp:Label>:</td>
                                                    <td>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txbOldPwd"
                                                            runat="server" ErrorMessage="Please enter Old Password" meta:resourcekey="rfvOld"></asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label4" runat="server" meta:resourcekey="lblNewPassword">New Password</asp:Label>:</td>
                                                    <td>
                                                        <input id="txbNewPwd" name="txbNewPwd" type="password" runat="server" maxlength="30" />
                                                        <span class="t01"><asp:Label ID="Label5" runat="server" meta:resourcekey="lblChar">(6-30 characters)</asp:Label></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label6" runat="server" meta:resourcekey="lblNewAgain">Type New Password Again</asp:Label>:</td>
                                                    <td>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" ControlToValidate="txbNewPwdAgain"
                                                            runat="server" ErrorMessage="Please enter Type New Password again " meta:resourcekey="rfvNew"></asp:RequiredFieldValidator>
                                                        <asp:CompareValidator ID="CompareValidator1" ControlToValidate="txbNewPwdAgain" ControlToCompare="txbNewPwd"
                                                            runat="server" Display="Dynamic" ErrorMessage="Please enter the same password in both the password boxes" meta:resourcekey="cpvNew"></asp:CompareValidator></td>
                                                </tr>
                                                <tr>
                                                    <td align="center">
                                                        &nbsp;</td>
                                                    <td align="left">
                                                        <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="search_btn" OnClick="btnUpdate_Click" meta:resourcekey="btnUpdate" />
