<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SuccessIncentiveTour.aspx.cs" EnableEventValidation="false"
    Inherits="SuccessIncentiveTour" validateRequest="false" %>

<%@ Register Src="../../UserControls/SendEmailIncentiveTourControl.ascx" TagName="SendEmailIncentiveTourControl"
    TagPrefix="uc3" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="MAIL_BODY" style="display:none">
            <uc3:SendEmailIncentiveTourControl ID="SendEmailIncentiveTourControl1" runat="server" />
        </div>
