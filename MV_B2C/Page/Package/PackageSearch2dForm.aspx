<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="PackageSearch2dForm" Codebehind="PackageSearch2dForm.aspx.cs" %>
...
//                document.getElementById("lbDepartureCode").value = str[index].value;
              ...
              {   
                ...
                index = str.selectedIndex;   
                document.getElementById("txtDestinationOne").value = str[index].text;
//                document.getElementById("lbDestinationOneCode").value = str[index].value;
              ...
              {   
                ...
                index = str.selectedIndex;   
                document.getElementById("txtDestinationTwo").value = str[index].text;
...
<body>
        ...
        <div id="content">
            ...
            <div id="subcontent_l">
                <div id="subcontent_l_l">
                    ...
                    </div><iframe style="visibility: hidden; position: absolute; width: 148px; height: 194px;
    ...
    marginwidth="0" noresize frameborder="0" scrolling="NO" src="../../CommJs/Mvcalx.htm"></iframe>
                    <h1>
                        <asp:Label ID="Label18" runat="server" meta:resourcekey="lblPackageSearch">Package Search</asp:Label>
                    </h1>
                    <div>
                        <h3>
                        ...
                        <div class="base">
                            <input name="radiobutton" type="radio" value="radiobutton" onclick="javascript:location.href='../../index.aspx'" />
                    ...
                    <div>
                        <h3>
                            ...
                            <asp:Label ID="Label4" runat="server" meta:resourcekey="lblDestinationsDate">Destinations &amp; Date</asp:Label>
                        </h3>
                        <div class="getFlight">
                            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                <tr>
                                    <td colspan="4" class="name">
                                        <asp:Label ID="Label5" runat="server" meta:resourcekey="lblDepartureReturn">Departure / Return</asp:Label></td>
                                </tr>
                                <tr>
                                    <td width="13%">
                                    ...
                                    <td width="41%">
                                        <%--<asp:TextBox ID="txtDepartureFrom" runat="server" />--%>
                                        <uc7:LocationTextBoxControl ID="txtDepartureFrom" runat="server"  />
                                         </td>
                                    <td width="16%">
                                        <img src="../../images/v1/fly.gif" width="20" height="17" align="absmiddle" />
                                        <asp:Label ID="Label7" runat="server" meta:resourcekey="lblDepartDate">Depart Date</asp:Label>:</td>
                                    <td width="30%">
                                        &nbsp;&nbsp;
                                        <uc6:Calendar ID="dateDeparture" runat="server" />
                                        <asp:Label ID="lblDateDepMsg" runat="server" ForeColor="Red" Text="Please enter date" Visible="False" meta:resourcekey="lblEnterDate"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        ...
                                        &nbsp;<asp:Label ID="lbFromSelect" runat="server" Text="Please select an airport." Visible="false" ForeColor="red" meta:resourcekey="lblSelectAirport"></asp:Label>
                            ...
                            <table width="100%" border="0" cellpadding="3" cellspacing="0" class="dotline">
                                <tr>
                                    ...
                                    <td width="5%" rowspan="2" valign="bottom">
                                        <img src="../../images/v1/hotel.gif" width="21" height="21" /></td>
                                    <td>
                                ...
                                <tr>
                                    <td width="37%">
                                        <%--<asp:TextBox ID="txtDestinationOne" runat="server" />--%>
                                    ...
                                    <td width="29%">
                                        ...
                                        <asp:Label ID="lblCheckInOneMsg" runat="server" ForeColor="Red" Text="Please enter date" Visible="False" meta:resourcekey="lblEnterDate"></asp:Label>
                                    </td>
                                    <td width="29%">
                                        &nbsp;&nbsp;
                                        <uc6:Calendar ID="dateCheckOutOne" runat="server" LowerLimitID="dateCheckInOne"/>
                                        <asp:Label ID="lblCheckOutOneMsg" runat="server" ForeColor="Red" Text="Please enter date" Visible="False" meta:resourcekey="lblEnterDate"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <asp:ListBox ID="listBDestinationOneAirport" runat="server" onchange="ChangeDepOneSelect()"
                                            Visible="False"></asp:ListBox>
                                         &nbsp;<asp:Label ID="lbSelectOne" runat="server" Text="Please select an airport." Visible="false" ForeColor="red" meta:resourcekey="lblSelectAirport">></asp:Label>
                                        <asp:Label ID="lbDestinationOneCode" runat="server" Visible="False"></asp:Label></td>
                                </tr>
                            </table>
                            <table width="100%" border="0" cellpadding="3" cellspacing="0" class="dotline">
                                <tr>
                                ...
                                <tr>
                                    <td width="37%" >
                                       <%-- <asp:TextBox ID="txtDestinationTwo" runat="server" />--%>
                                    ...
                                    <td width="29%" >
                                        ...
                                        <asp:Label ID="lblCheckInTwoMsg" runat="server" ForeColor="Red" Text="Please enter date" Visible="False" meta:resourcekey="lblEnterDate"></asp:Label>
                                    </td>
                                    <td width="29%" >
                                        &nbsp;&nbsp;
                                        <uc6:Calendar ID="dateCheckOutTwo" runat="server" LowerLimitID="dateCheckInTwo" />
                                        <asp:Label ID="lblCheckOutTwoMsg" runat="server" ForeColor="Red" Text="Please enter date" Visible="False" meta:resourcekey="lblEnterDate"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <asp:ListBox ID="listBReturnAirport" runat="server" onchange="ChangeRtnSelect()"
                                            Visible="False"></asp:ListBox>
                                        &nbsp;<asp:Label ID="lbSelectTwo" runat="server" Text="Please select an airport." Visible="false" ForeColor="red" meta:resourcekey="lblSelectAirport">></asp:Label>
                            ...
                            <table width="100%" border="0" cellpadding="3" cellspacing="0" class="dotline">
                                <tr>
                                    <td width="16%">
                                        <img src="../../images/v1/fly.gif" width="20" height="17" align="absmiddle" />
                                        <asp:Label ID="Label14" runat="server" meta:resourcekey="lblReturnDate">Return Date</asp:Label>:</td>
                                    <td>
                                        &nbsp;
                                        <TermsCalender:TermsCalendar ID="dateReturn" runat="server" ImageUrl="~/Terms.Sales.Web/images/cal.jpg"
                                            Width="100px" ValidationGroup="a"  LowerLimitID="dateCheckOutTwo" IsLowerRepeatDate="1" IsUpperRepeatDate = "1"/>
                                        <asp:Label ID="lblReturnMsg" runat="server" ForeColor="Red" Text="Please enter date" Visible="False" meta:resourcekey="lblEnterDate"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                            <table width="100%" border="0" cellpadding="3" cellspacing="0" class="dotline">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chbFlexible" runat="server" Text="My dates are flexible +/- 1 day" meta:resourcekey="chbFlexible" />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="16%">
                    ...
                    <div class="btn">
                        <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" ValidationGroup="a"  meta:resourcekey="btnSearch"/>
