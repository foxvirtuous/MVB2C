<%@ Page Language="C#" MasterPageFile="~/Page/Promos/Promos.Master" AutoEventWireup="true"
    Codebehind="PromosAirListForm.aspx.cs" Inherits="PromosAirListForm" EnableEventValidation="false"
...
<%@ MasterType VirtualPath="~/Page/Promos/Promos.Master" %>
...
//                document.getElementById( btnShrink ).style.display = "block";
    ...
    {
		if(document.getElementById("ctl00_MainContent_flagSearch") != null)
		{
		    document.getElementById("ctl00_MainContent_flagSearch").value = document.getElementById("MAIL_BODY").innerHTML;
		    }
	}
	...
	{
		GetFormContent();
		document.getElementById("ctl00_MainContent_IsFinised").value ="yes";
    ...
    <div id="Div1">
        <input id="flagSearch" runat="server" type="hidden" value="" /><input id="IsFinised"
                                ...
                                <tr>
                                    <td style="width: 99px;">
                                        <table class="table_mode row1" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td style="height: 46px; text-decoration: underline;" align="center">
                                                ...
                                                <table class="dataList" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        ...
                                                        <td style="background: rgb(234, 234, 234) none repeat scroll 0%; width: 100%; height: 54px;
                                                            ...
                                                            align="center">
                                                            <asp:Label ID="lnkAirLine" runat="server">
                                                    ...
                                                    <tr>
                                                        <td style="height: 46px; padding: 0px 10px; word-wrap: break; word-break: break-all;
                                                            ...
                                                            <asp:Label ID="lnbZeroBase" runat="server">
                                                    ...
                                                    <tr>
                                                        <td style="height: 46px; padding: 0px 10px; word-wrap: break; word-break: break-all;
                                                            ...
                                                            <asp:Label ID="lnbOneBase" runat="server">
                                                                <div style="font-size: 14px;">
                                                    ...
                                                    <tr>
                                                        <td style="height: 46px; padding: 0px 10px; word-wrap: break; word-break: break-all;
                                                            ...
                                                            <asp:Label ID="lnbTwoMoreBase" runat="server">
                                                                <div style="font-size: 14px;">
                                                    ...
                                                    <tr>
                                                        <td style="height: 46px; padding: 0px 10px; word-wrap: break; word-break: break-all;
                                                            ...
                                                            <asp:Label ID="lnbSelect" runat="server">
                                                                <div style="font-size: 14px;">
                ...
                <td width="735">
                    <asp:UpdatePanel ID="upFilterMessage" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Panel ID="pnlBackToAllResults" class="loadPage" Visible="false" runat="server">
                                    ...
                                    <asp:UpdatePanel ID="upSrotByMessage" UpdateMode="Conditional" runat="server">
                                        <ContentTemplate>
                                            <div style="float: right; text-align: right; margin: 3px; margin-left: 10px;">
                                                ...
                                                <asp:LinkButton ID="lb_sortAirline" runat="server" CssClass="sortClass" meta:resourcekey="lb_sortAirline">
                                                    Airline<asp:Image ID="img_airlineUp" ImageUrl="~/Page/Flight/images/sort-up.gif"
                                                        runat="server" Visible="false"></asp:Image><asp:Image ID="img_airlineDown" ImageUrl="~/Page/Flight/images/sort-down.gif"
                                                            runat="server" Visible="false"></asp:Image></asp:LinkButton>
                                                <asp:LinkButton ID="lb_sortDuration" runat="server" CssClass="sortClass" meta:resourcekey="lb_sortDuration">
                                                    Duration<asp:Image ID="img_DurationUp" ImageUrl="~/Page/Flight/images/sort-up.gif"
                                                        runat="server" Visible="false"></asp:Image><asp:Image ID="img_DurationDown" ImageUrl="~/Page/Flight/images/sort-down.gif"
                                                            runat="server" Visible="false"></asp:Image></asp:LinkButton>
                                                <asp:LinkButton ID="lb_sortDeparture" runat="server" CssClass="sortClass" meta:resourcekey="lb_sortDeparture">
                                                    Departure Time<asp:Image ID="img_departureUp" ImageUrl="~/Page/Flight/images/sort-up.gif"
                                                        runat="server" Visible="false"></asp:Image><asp:Image ID="img_departureDown" ImageUrl="~/Page/Flight/images/sort-down.gif"
                                                            runat="server" Visible="false"></asp:Image></asp:LinkButton>
                                                <asp:LinkButton ID="lb_sortArrival" runat="server" CssClass="sortClass" meta:resourcekey="lb_sortArrival">
                                                    Arrival Time<asp:Image ID="img_arrivalUp" ImageUrl="~/Page/Flight/images/sort-up.gif"
                                            ...
                                            <ItemTemplate>
                                                <asp:Panel ID="pnlWholeFlightItem" runat="server" class="pnlWholeFlightItem">
                                                    <div class="outside1T">
                                                                ...
                                                                <tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right">
                                                                                    <div>
                                                                                        ...
                                                                                        <asp:Label ID="Label15" CssClass="PriceByRed" runat="server" Text='<%#  ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultBaseFare.ToString().Equals("0")?"":(((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultMarkup).ToString("$#,###") %>'></asp:Label>
                                                                                        ...
                                                                                        <asp:Label ID="lblTax" runat="server" Text='<%# " = " +  (((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultMarkup + ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultTax).ToString("$#,###.##") + " " %>'
                                                                                    ...
                                                                                    <asp:Panel ID="divChildFareDetail" runat="server">
                                                                                        ...
                                                                                        <asp:Label ID="Label12" CssClass="PriceByRed" runat="server" Text='<%#  ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildBaseFare.ToString().Equals("0")?"":(((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildMarkup).ToString("$#,###") %>'></asp:Label>
                                                                                        ...
                                                                                        <asp:Label ID="lblChildTotal" runat="server" Text='<%# " = " + (((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildMarkup + ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildTax).ToString("$#,###.##") + " " %>'
                                                                    ...
                                                                    <td width="15%" align="center">
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Label ID="Label19" CssClass="blueByPrice" runat="server" Text='<%#  ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultBaseFare.ToString().Equals("0")?"":(((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultMarkup).ToString("$#,###") %>'></asp:Label>
                                                        </div>
                                                        </td> </tr>
                                                        <!--Child 默认隐藏-->
                                                        <tr>
                                                            <td>
                                                                <asp:Panel ID="divChildFare" Visible="false" runat="server" class="left" Style="width: 100%;">
                                                                    ...
                                                                    <asp:Label ID="Label10" CssClass="blueByPrice" runat="server" Text='<%#  ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildBaseFare.ToString().Equals("0")?"":(((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildMarkup).ToString("$#,###") %>'></asp:Label></asp:Panel>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center">
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="lbDispOverNightMessage" ForeColor="red" runat="server" Visible="false"></asp:Label><br>
                                                                                ...
                                                                                <tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="right">
                                                                                                    <div>
                                                                                                        ...
                                                                                                        <asp:Label ID="lbl_AdultFare" runat="server" Text='<%#  ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultBaseFare.ToString().Equals("0")?"":(((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultMarkup).ToString("$#,###") + " "%>'
                                                                                                            CssClass="PriceByRed"></asp:Label><span style="color: #2B4D87;">base</span>
                                                                                                        <asp:Label ID="lblAdultTaxTotal" runat="server" Text='<%# " + " + ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultTax.ToString("$#,###.##") +  " tax = " + (((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultMarkup + ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultTax).ToString("$#,###.##") + " total" %>'
                                                                                                    ...
                                                                                                    <asp:Panel ID="divChildFareDetail" runat="server">
                                                                                                        ...
                                                                                                        <asp:Label ID="Label12" CssClass="PriceByRed" runat="server" Text='<%#  ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildBaseFare.ToString().Equals("0")?"":(((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildMarkup).ToString("$#,###") + " "%>'></asp:Label><span
                                                                                                            style="color: #2B4D87;">base</span>
                                                                                                        <asp:Label ID="lblChildTaxTotal" runat="server" Text='<%# " + " + ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildTax.ToString("$#,###.##") +  " tax = " + (((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildMarkup + ((AirMaterial)DataBinder.Eval(Container,"DataItem")).ChildTax).ToString("$#,###.##") + " total" %>'
                                                                                    ...
                                                                                    <td width="15%" align="center">
                                                                                        <table>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <asp:Label ID="lblDisplayMoney" CssClass="blueByPrice" runat="server" Text='<%#  ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultBaseFare.ToString().Equals("0")?"":(((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultBaseFare+ ((AirMaterial)DataBinder.Eval(Container,"DataItem")).AdultMarkup).ToString("$#,###") %>'></asp:Label>
                                                                        </div>
                                                                        </td> </tr>
                                                                        <!--Child 默认隐藏-->
                                                                        <tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="40%" rowspan="2" align="center">
                                            <img src="images/ad_low.gif" />
                                        </td>
                                        <td colspan="2" align="center">
                                            <img src="images/ad_call.jpg" /></td>
                                    </tr>
                                    <tr>
                                                            ...
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="2">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="left">
                                                                            <asp:TextBox ID="txtPhone" runat="server" CssClass="normal"></asp:TextBox></td>
                                                                        <td align="right" valign="bottom">
                                                                            &nbsp;
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td align="left">
                                                                            <asp:TextBox ID="txtEmail" runat="server" CssClass="normal"></asp:TextBox></td>
                                                                        <td valign="bottom">
                                                                            <asp:Button ID="btnSendEmail" runat="server" Text="送出" Style="color: #444444; font-size: 12px"
    ...
    <div id="MAIL_BODY" visible="false" style="display: none">
        <div>
            <div style="width: 100%; float: left; position: relative;">
                <ul>
                    <li style="width: 150px; z-index: 1000; position: relative; margin-bottom: -2px;">
                        <asp:Label ID="lblAirlineMartrixCopy" runat="server" meta:resourcekey="lblAirlineMartrix">Airline Matrix</asp:Label></li>
                    <li>
                        <asp:Label ID="lblDepartureCityCopy" runat="server" Text="Label"></asp:Label>-<asp:Label
                            ID="lblArrivalCityCopy" runat="server" Text="Label"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label
                                ID="lblDepatureDateMsgCopy" runat="server" meta:resourcekey="lblDepatureDateMsg">Depart Date</asp:Label>:&nbsp;<asp:Label
                                    ID="lblDepartureDateCopy" runat="server" Text="Label"></asp:Label>&nbsp;&nbsp;<asp:Label
                                        ID="lblReturnDateMsgCopy" runat="server" meta:resourcekey="lblReturnDateMsg">Return Date</asp:Label>:&nbsp;<asp:Label
                                            ID="lblReturnDateCopy" runat="server" Text="Label"></asp:Label></li>
                </ul>
            </div>
        </div>
        <table style="border: 1px solid #CCCCCC; font-family: verdana; float: left; width: 100%;
            border-right: none;" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td style="width: 99px;">
                    <table style="height: 100%; font-size: 11px; color: #3366CC; text-decoration: underline;"
                        cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td style="border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC; background: #EAEAEA;">
                                <img src="http://www.majestic-vacations.com/Page/Promos/images/MatrixFindBy.gif"
                                    alt="" border="0" />
                            </td>
                        </tr>
                        <tr>
                            <td style="border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC; background: #EAEAEA;
                                height: 46px; text-decoration: underline;" align="center">
                                <asp:LinkButton ID="lnkZeroStopTotalCopy" OnClientClick="link_to_achor(this);" CommandName="ZeroStop"
                                    runat="server" Style="color: #FF3300;" meta:resourcekey="lblstop0">0 stop</asp:LinkButton></td>
                        </tr>
                        <tr>
                            <td style="border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC; background: #EAEAEA;
                                height: 46px; text-decoration: underline;" align="center">
                                <asp:LinkButton ID="lnkOneStopTotalCopy" OnClientClick="link_to_achor(this);" CommandName="OneStop"
                                    runat="server" Style="color: #FF3300" meta:resourcekey="lblstop1">1 stops</asp:LinkButton></td>
                        </tr>
                        <tr>
                            <td style="border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC; background: #EAEAEA;
                                height: 46px; text-decoration: underline;" align="center">
                                <asp:LinkButton ID="lnkMoreThanTwoStopTotalCopy" OnClientClick="link_to_achor(this);"
                                    CommandName="MoreThanTwoStop" runat="server" Style="color: #FF3300;" meta:resourcekey="lblstop2">2+ stops</asp:LinkButton></td>
                        </tr>
                        <tr>
                            <td style="border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC; background: #EAEAEA;
                                height: 46px; border-bottom: none; font-weight: bold; color: #FF3300; text-decoration: underline;"
                                align="center">
                                <asp:Label ID="Label32" runat="server" meta:resourcekey="lblLowFareSelect">Low Fare Select</asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
                <td>
                    <asp:DataList ID="dlAirlineMatricsCopy" runat="server" RepeatDirection="Horizontal"
                        Width="100%" CellPadding="0" CellSpacing="0" OnItemDataBound="dlAirlineMatricsCopy_ItemDataBound">
                        <ItemTemplate>
                            <table style="height: 100%; width: 100%;" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="background: rgb(234, 234, 234) none repeat scroll 0%; width: 100%; height: 54px;
                                        ...
                                        -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial;"
                                        align="center">
                                        <asp:Label ID="lnkAirLineCopy" runat="server">
                                            <%--<asp:Image Height="18" ID="imgAirlineCopy" runat="server" ToolTip='<%# ((Airline)Eval("AirLine")).Name %>'
                                                    Width="18" Style="text-decoration: none;"></asp:Image><br />--%>
                                            <asp:Label ID="Label1" runat="server" Text='<%# ((Airline)Eval("AirLine")).Code %>'
                                                ToolTip='<%# ((Airline)Eval("AirLine")).Name %>'></asp:Label>
                                        </asp:Label>
                                ...
                                <tr>
                                    <td style="height: 46px; padding: 0px 10px; word-wrap: break; word-break: break-all;
                                        white-space: nowrap;" align="center">
                                        <asp:Label ID="lblZeroStopPriceCopy" runat="server" Text=""></asp:Label>
                                        <asp:Label ID="lnbZeroBaseCopy" runat="server">
                                            <div style="font-size: 14px;">
                                                $<%# ((AirMatrixFlightMeta.Price)Eval("ZeroStopPrice")).BaseFare %>
                                            </div>
                                            <div style="font-size: 11px;">
                                ...
                                <tr>
                                    <td style="height: 46px; padding: 0px 10px; word-wrap: break; word-break: break-all;
                                        white-space: nowrap;" align="center">
                                        <asp:Label ID="lblSpaceOneStopPriceCopy" runat="server" Text=""></asp:Label>
                                        <asp:Label ID="lnbOneBaseCopy" runat="server">
                                            <div style="font-size: 14px;">
                                                $<%# ((AirMatrixFlightMeta.Price)Eval("OneStopPrice")).BaseFare%>
                                            </div>
                                            <div style="font-size: 11px;">
                                ...
                                <tr>
                                    <td style="height: 46px; padding: 0px 10px; word-wrap: break; word-break: break-all;
                                        white-space: nowrap;" align="center">
                                        <asp:Label ID="lblSpaceMoreThanTwoStopPriceCopy" runat="server" Text=""></asp:Label>
                                        <asp:Label ID="lnbTwoMoreBaseCopy" runat="server">
                                            <div style="font-size: 14px;">
                                                $<%# ((AirMatrixFlightMeta.Price)Eval("MoreThanTwoStopPrice")).BaseFare%>
                                            </div>
                                            <div style="font-size: 11px;">
                                ...
                                <tr>
                                    <td style="height: 46px; padding: 0px 10px; word-wrap: break; word-break: break-all;
                                        white-space: nowrap; border-bottom: none;" align="center">
                                        <asp:Label ID="lblSpaceSelectCopy" runat="server" Text=""></asp:Label>
                                        <asp:Label ID="lnbSelect" runat="server">
                                            <div style="font-size: 14px;">
                                                <asp:Label ID="lblLowFareSelectCopy" runat="server">$<%# ((AirMatrixFlightMeta.Price)Eval("LowFareSelectPrice")).BaseFare%> </asp:Label>
                                            </div>
                                            <div style="font-size: 11px;">
                                                <asp:Label ID="lblLowFareSelectTooltipCopy" runat="server">
                                                    <asp:Label ID="Label18" runat="server" meta:resourcekey="lblBase">Base</asp:Label></asp:Label>
                                            </div>
                                        </asp:Label>
                                    </td>
