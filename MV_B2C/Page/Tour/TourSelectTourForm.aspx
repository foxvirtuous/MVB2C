<%@ Page Language="C#" MasterPageFile="TourBookingPage.Master" AutoEventWireup="true"
    Inherits="TourSelectTourForm" EnableEventValidation="false" Codebehind="TourSelectTourForm.aspx.cs" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td align="left" style="height: 48px">
                                <span class="head06">
                                    <asp:Label ID="Label3" runat="server" meta:resourcekey="lblTourItinerary">Tour Itinerary</asp:Label></span></td>
                        </tr>
                    </table>
                </td>
            </tr>
                        ...
                        <td valign="top">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" id="TABLE1">
                                ...
                                <tr align="left" height="3">
                                    <asp:LinkButton ID="lbtnMore" runat="server" OnClick="lbtnMore_Click" Visible=false style="display:none" >More</asp:LinkButton></tr>
                                <tr>
                                    <td height="3">
                                    </td>
                                </tr>
                                    ...
                                    <tr class="R_stepo" width="100%">
                                        <td valign="top" width="100%">
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                <tbody>
                                                    <tr width="100%">
                                                        <td height="15px" width="100%" align="right">
                                                    ...
                                                    <tr width="100%">
                                                        <td width="100%">
                                                            ...
                                                            <div runat="server" id="divLandOnly">
