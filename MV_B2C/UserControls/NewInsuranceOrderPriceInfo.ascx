<%@ Control Language="C#" AutoEventWireup="true" Codebehind="NewInsuranceOrderPriceInfo.ascx.cs"
    Inherits="NewInsuranceOrderPriceInfo" %>
    ...
    <tbody>
        <tr valign="top">
            <td>
                ...
                <div class="IBE_package_SearchCondition_T_step04_totalPrice">
                    <font class="step3_price_price">Total Price:</font> <font class="step3_price_price">
                        $<asp:Label ID="lblHotelOrderTotalPrice" runat="server"></asp:Label></font>
                </div>
            </td>
        </tr>
    </tbody>
