<%@ Control Language="C#" AutoEventWireup="true" Inherits="OrderView" Codebehind="OrderView.ascx.cs" %>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                    ...
                                    <asp:Repeater ID="rptRoom" runat="server" DataSource='<%# DataBinder.Eval(Container.DataItem, "RoomTypes") %>'>
                                        <ItemTemplate>
                                            <tr>
                                                <td >
                                                    <asp:Label ID="Label14" runat="server" meta:resourcekey="lblRoom">Room</asp:Label> #<asp:Label ID="lblRoomNumber" runat="server" Text='<%# Container.ItemIndex + 1 %>'></asp:Label>: <asp:Label ID="lbHotelDetails" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Room.Name")  %>'></asp:Label></td>
                                                    <td><asp:Label
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        </uc3:ViewTransportationControl></td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
    ...
    <tr>
        <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <%--<tr>
              <td width="19%"> Single Supplement: </td>
            ...
            <tr>
              <td class="ctline"> Airport Transfer: </td>
              <td class="ctline"> $ 18.00 </td>
            </tr>--%>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        / <span class="orglab">$<asp:Label ID="lbAvgPrice" runat="server"></asp:Label>
