<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="SendEmailTourControl" Codebehind="SendEmailTourControl.ascx.cs" %>
<%@ Register Src="TourPriceInfoControl.ascx" TagName="TourPriceInfoControl" TagPrefix="uc9" %>
<%@ Register Src="PriceInfoControl.ascx" TagName="PriceInfoControl" TagPrefix="uc7" %>
<%@ Register Src="TravelerInfoControl.ascx" TagName="TravelerInfoControl" TagPrefix="uc7" %>
<%@ Register Src="ContactViewControl.ascx" TagName="ContactViewControl" TagPrefix="uc6" %>
<%@ Register Src="ContactInfoControl.ascx" TagName="ContactInfoControl" TagPrefix="uc3" %>
<%@ Register Src="TourItineraryInMailControl.ascx" TagName="TourItineraryInMailControl"
    TagPrefix="uc5" %>
<%@ Register Src="TourMainInfoControl.ascx" TagName="TourMainInfoControl" TagPrefix="uc10" %>
<style type="text/css">
<!--
                ...
                <tr>
                    <td align="right" valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="left">
                                    ...
                                    US Eastern Time. Our sales representitive with contact you in 24 hours to confirm your booking.</td>
                            </tr>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tr>
                                            <td height="120">
                                                ...
                                                <uc10:TourMainInfoControl ID="TourMainInfoControl1" runat="server" />
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td height="10">
                                                        </td>
                                                ...
                                                <uc5:TourItineraryInMailControl ID="TourItineraryInMailControl1" runat="server" />
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td height="10">
                                                        </td>
                                                ...
                                                <table class="MailT_step02" align="center" border="0" cellpadding="0" cellspacing="1"
                                                    width="100%" runat="server" visible="false" id="tbRemark" >
                                                    <tr class="MailR_stepw">
                                                        <td align="center">
                                                            <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                                                <tr align="center" class="MailR_order03">
                                                ...
                                                <uc9:TourPriceInfoControl ID="TourPriceInfoControl1" runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="1" cellpadding="8" class="MailT_step02">
                                        <tr class="MailR_stepw">
                                            <td align="left">
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <%--<tr>
                <td align="center"><input name="ctl00$MainContent$btnContinue" value="Print out this page" id="ctl00_MainContent_btnContinue" type="submit"></td>
            </tr>--%>
                        </table>
                    </td>
                </tr>
