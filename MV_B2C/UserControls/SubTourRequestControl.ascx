<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubTourRequestControl.ascx.cs" Inherits="SubTourRequestControl" %>
                                            ...
                                            <table width="193" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td style="border-bottom: solid #CCCCCC 1px">
                                                        <asp:Image ID="imgTour" runat="server" ImageUrl='<%# DataBinder.Eval(Container.DataItem, "Image") %>' Width="150" Height="100" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td width="1" background="/images/box_mid.gif">
