<%@ Control Language="C#" AutoEventWireup="true" Codebehind="VehcileInfoControl.ascx.cs"
    Inherits="VehcileInfoControl" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="center" style="padding: 35px 0px 20px 0px;">
                        <asp:LinkButton ID="lbtnBack" runat="server" CssClass="d13" OnClick="lbtnBack_Click">Back to Car Details</asp:LinkButton><br />
